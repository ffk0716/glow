...
BB.newBackendSpecificInstr("SophonFullyConnected")
    ...
    .autoIRGen()
    .autoVerify(VerifyKind::SameElementType, {"Dest", "Src", "Weights", "Bias"});
#endif
...
//    .addInput("Bias")   //!< delete
    ...
    .addMember(MemberType::Float, "Epsilon")
    .autoIRGen()
    .autoVerify(VerifyKind::SameElementType, {"Dest", "Src", "Mean", "Variance"});
...
BB.newBackendSpecificInstr("SophonLocalResponseNormalization")
    ...
    //.addMember(MemberType::Float, "bias") caffe里好像没该参数，暂时注释�
...
BB.newBackendSpecificInstr("SophonLSTM")
    ...
    .autoIRGen()
    .autoVerify(VerifyKind::SameElementType, {"Dest", "Src", "W", "R", "B", "P"});
...
BB.newBackendSpecificInstr("SophonConcat")
    .addOperand("Dest", OperandKind::Out)
    //.addMember(MemberType::VectorNodeValue, "Inputs") //delete this, use LHS and RHS
                                                        //if concat number>3, use concat 2 times
...
BB.newBackendSpecificInstr("ParallelEnable")
    .autoVerify(VerifyKind::NoVerify);

BB.newBackendSpecificInstr("ParallelDisable")
    .autoVerify(VerifyKind::NoVerify);
